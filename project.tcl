...
$ns trace-all $udpSinkFile0
set udpSinkFile1 [open udpout1.tr w]
$ns trace-all $udpSinkFile1
set tcpCwndFile0 [open tcpout0.t w]
$ns trace-all $tcpCwndFile0
set tcpCwndFile1 [open tcpout1.tr w]
$ns trace-all $tcpCwndFile1
set tcpCwndFile2 [open tcpout2.tr w]
$ns trace-all $tcpCwndFile2
set namfile [ open out.nam w ]
$ns namtrace-all $namfile
puts "Saving out.nam"
proc finish {} {
global ns namfile udpSinkFile0 udpSinkFile1 tcpCwndFile0 tcpCwndFile1
tcpout2 global ns tcpCwndFile2
close $udpSinkFile0
close $udpSinkFile1
close $tcpCwndFile0
close $tcpCwndFile1
...
close $namfile
exec nam out.nam &
exec xgraph udpout0.tr
 udpout1.tr
 &
exec xgraph tcpout0.tr
 tcpout1.tr
 &
exec xgraph tcpout0.tr
 tcpout2.tr
 &
exec xgraph tcpout1.tr
 tcpout2.tr
 &
exit 0
}
proc record {} {
global udpsink0 udpSinkFile0 udpsink1 udpSinkFile1 tcp0 tcpCwndFile0
tcp1 tcpCwndFile1 tcp2 tcpCwndFile2
...
$ns at 14.4 "$ftp0 stop"
$ns at 14.5 "$ftp1 stop"
$ns at 14.6 "$ftp2 start"
$ns at 14.7 "$cbr0 stop"
$ns at 14.8 "$cbr1 stop"
$ns at 15.0 "finish"
